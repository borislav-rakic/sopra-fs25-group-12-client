  ...
  return (
    <>
      ...
      {visible && (
        ...
        >
          <div>
            <strong>Match Phase:</strong> {gameData.matchPhase}
          </div>
          <div>
            <strong>Game Phase:</strong> {gameData.gamePhase}
          </div>
          <div>
            <strong>Trick Phase:</strong> {gameData.trickPhase}
          </div>
          ...
          <div>
            <strong>Scores:</strong> {gameData.playerPointsString}
          </div>
        </div>
      )}
    </>
