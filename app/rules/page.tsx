  ...
  return (
    <div style={{ padding: "40px", maxWidth: "800px", margin: "0 auto" }}>
      <Card variant="borderless">
        ...
        <Paragraph>
        Hearts is a trick-taking card game played with 4 players. The goal is to avoid gaining points by **not collecting Hearts** or the **Queen of Spades**.
        </Paragraph>
        ...
        <Paragraph>
        Before the first round begins, each player selects <strong>3 cards</strong> from their hand to pass to another player:
        <br />
        ...
        <Paragraph>
        The player holding the <strong>2♣ (Two of Clubs)</strong> always starts the first round by playing that card. The other players must follow suit (play a ♣ club) if they can. If they don&apos;t have that suit, they can play any other card.
        </Paragraph>

        <Paragraph>
        This group of four played cards is called a <strong>trick</strong>. The player who plays the highest card in the lead suit (the suit of the first card played) <strong>wins the trick</strong> and collects the 4 cards.
        </Paragraph>
